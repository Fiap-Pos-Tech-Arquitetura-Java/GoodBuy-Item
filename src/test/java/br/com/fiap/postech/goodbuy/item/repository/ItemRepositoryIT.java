...
public class ItemRepositoryIT {
    ...
    @Autowired
    public ItemRepositoryIT(ItemRepository itemRepository) {
    ...
    void devePermitirBuscarItem() {
        ...
        itemOpcional.ifPresent(
                itemRecebido -> {
                    ...
                    assertThat(itemRecebido.getNome()).isEqualTo(nome);
                }
        );
    }
    @Test
    void devePermitirRemoverItem() {
        // Arrange
        var id = UUID.fromString("759ae7fa-2cd2-46ef-9c54-737a4d9d408d");
        // Act
